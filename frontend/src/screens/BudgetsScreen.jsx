...
const BudgetsScreen = ({ categories }) => {
  // Estado para gerenciar orçamentos - dados mockados baseados na imagem
  ...
  // Função para calcular a porcentagem gasta
  ...
  // Componente de alerta de exclusão (reutilizado do FinanceApp)
              ...
              <div>
                ...
                <div className="relative">
                  <select 
                    ...
                    disabled={editingBudget} // Desabilita categoria ao editar
                  >
