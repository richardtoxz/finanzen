...
// ===================================================================================
// Constantes de Estilo e Componentes Auxiliares
// Reutilizar constantes e componentes auxiliares torna o código principal mais limpo.
// ===================================================================================
...
// Componente auxiliar para o alerta de exclusão de categoria
...
// Cada componente tem uma responsabilidade clara (Sidebar, Conteúdo, Modais).
// ===================================================================================
...
const CategoriesModal = ({ showCategoriesModal, setShowCategoriesModal, categories, setCategories }) => {
  ...
  const [editingCategory, setEditingCategory] = useState(null); // Armazena o objeto { id, name } da categoria em edição
  const [deletingId, setDeletingId] = useState(null); // Armazena o ID da categoria a ser excluída
  ...
  // Componente para uma linha da tabela de categorias
...
// ===================================================================================
// Componente Raiz da Aplicação (FinanceApp)
// Orquestra o estado global, a navegação e a renderização dos componentes.
// ===================================================================================
...
const FinanceApp = ({ user, onLogout }) => {
  ...
  switch (currentView) {
    ...
    case 'budgets':  // ADICIONAR ESTA LINHA
      return <BudgetsScreen categories={categories}/>;  // ADICIONAR ESTA LINHA
    case 'overview':
    default:
      return (
        <OverviewContent
