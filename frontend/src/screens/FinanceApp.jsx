        ...
        <div className="p-4 lg:p-6">
          ...
          <div className="space-y-3 lg:space-y-4 mb-4 lg:mb-6">
            ...
            <div>
              ...
              <input type="text" name="description" value={transactionData.description} onChange={handleTransactionChange} maxLength={30} className="block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-200 focus:border-gray-400" placeholder="(opcional, máx 30 caracteres)" />
            </div>
          </div>
          <button className="w-full bg-black text-white py-3 rounded-md font-medium hover:bg-gray-800 cursor-pointer" onClick={() => { console.log('Salvar transação:', {...transactionData, valor: parseCurrency(transactionData.valor), type: transactionType }); setShowModal(false); setTransactionData({ valor: '0,00', date: '', description: '', category: '' }); }}>Salvar Transação</button>
        </div>
      </div>
    </div>
  );
